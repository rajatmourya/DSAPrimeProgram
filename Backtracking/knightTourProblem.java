...
public class knightTourProblem {
    ...
    public static int[][] knightTour(int n, int m) {
        ...
        knightTourhelpper(n,m,a,moveX,moveY,0,0,1);
        if(m > 1 && a[0][1] == -1){
            a[0][0] = -1;
        }
    ...
    static boolean knightTourhelpper(int n, int m, int a[][], int moveX[],
        ...
        for (int i = 0; i <8 ; i++) {
            ...
            if (isValid(n,m,a,nextX,nextY)){
                ...
                boolean isTourCompleteByGoingThere =
                        knightTourhelpper(n,m,a,moveX,moveY,nextX,nextY,step+1);
