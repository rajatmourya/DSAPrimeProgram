...
public class CountTheOccurrenceOfAnElementInASortedArray {
...
//        int k = 13;
        ...
        Arrays.sort(a);
        System.out.println(k + " is present in the Array " + CountOccurrence(a,k) + " times");
    }

    static int CountOccurrence(int[] a, int k){
        int fo = firstOccurrenceOfAnEISA(a,k);
        if(fo == -1) return 0;
        int lo = lastOccurrenceOfAnEISA(a,k);
